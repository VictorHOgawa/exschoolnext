            ...
            <div className="row align-items-center">
              <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                <div className="hero__content hero__content-2 p-relative z-index-1">
                  ...
                  <h4>Acesso ilimitado a 60+ instrutores.</h4>
                  <p>2 passes (com acesso a todas as classes) por R$240</p>
                  ...
                  <div className="hero__search">
                    <form action="#">
                      <div className="hero__search-input mb-10">
                        <input
                          type="text"
                          placeholder="O quê você quer Aprender?"
                        />
                        <button type="submit">
                    ...
                    <p>Você vai encontrar algo que seja certo para você.</p>
                  </div>
                </div>
              </div>
              <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                <div className="hero__thumb-wrapper mb--120">
                  <div className="hero__thumb-2 scene">
                    <img
                      className="hero-big"
                      src="assets/img/hero/hero-2/hero.png"
                      alt="img not found"
                    />
                    <img
                        ...
                        <span>
                          <svg viewBox="0 0 512 512">
                            <g>
                              ...
                              <path
                                className="st0"
                                d="M271,259.5l-15-30l-15,30V271h30V259.5z"
                              />
                              <path
                                className="st0"
                                d="M241,301h30v60h-30V301z"
                              />
                              <path
                                className="st0"
                    ...
                    >
                      ...
                      <div className="hero__promotion-text">
                        <h5>
                          <span className="counter">450</span>K
                        </h5>
                        <p>Alunos</p>
                      </div>
                    </div>
                    ...
                    >
                      <div className="hero__class-thumb mr-15">
                        <img
                          src="assets/img/hero/hero-2/hero-sm.jpg"
                          alt="img not found"
                        />
                      </div>
                      <div className="hero__class-text">
                        <h5>Amanhã é a nossa</h5>
                        <p>Aula de Experiência de Usuário</p>
                        <Link href="/contact">
                          <a>Acesse agora</a>
                        </Link>
                      </div>
