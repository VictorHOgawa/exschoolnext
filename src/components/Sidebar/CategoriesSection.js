          ...
          <ul>
            ...
            <li>
              <div className="course__sidebar-check mb-10 d-flex align-items-center">
                ...
                <label className="m-check-label" htmlFor="m-edu">
                  Educação (8)
                </label>
              </div>
            </li>
            <li>
              <div className="course__sidebar-check mb-10 d-flex align-items-center">
                ...
                <label className="m-check-label" htmlFor="m-bus">
                  Negócios (5)
                </label>
              </div>
            </li>
            <li>
              <div className="course__sidebar-check mb-10 d-flex align-items-center">
                <input
                  ...
                  id="m-design"
                />
                <label className="m-check-label" htmlFor="m-design">
                  Design de UX (3)
                </label>
              </div>
            </li>
            <li>
              <div className="course__sidebar-check mb-10 d-flex align-items-center">
                ...
                <label className="m-check-label" htmlFor="m-math">
                  Matemática (3)
                </label>
              </div>
            </li>
