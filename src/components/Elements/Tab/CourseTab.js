            ...
            <div className="course__menu d-flex justify-content-lg-end mb-60">
              <div className="masonary-menu filter-button-group">
                <TabList>
                  <Tab>
                    <button>
                      Ver Todos <span className="tag">novos</span>
                    </button>
                  </Tab>
                  <Tab>
                    <button>Tendendo</button>
                  </Tab>
                  <Tab>
                ...
                <div className="course__content">
                  <div className="course__meta d-flex align-items-center justify-content-between">
                    <div className="course__lesson">
                      <span>
                        <i className="fas fa-book"></i>43 Lições
                      </span>
                    </div>
                  ...
                  <h3 className="course__title">
                    <Link href="/course-details">
                      <a>
                        Aprenda as habilidades e o trabalho para se tornar um
                        Product Manager
                      </a>
                    </Link>
                  </h3>
            ...
            <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
              <div className="course__item white-bg mb-30 fix">
                <div className="course__thumb w-img p-relative fix">
                  ...
                  <div className="course__tag">
                    <Link href="/course-details">
                      <a className="sky-blue">Arte & Design</a>
                    </Link>
                  </div>
                </div>
                <div className="course__content">
                  <div className="course__meta d-flex align-items-center justify-content-between">
                    <div className="course__lesson">
                      <span>
                        <i className="fas fa-book"></i>72 Lições
                      </span>
                    </div>
                    <div className="course__rating">
                      <span>
                  ...
                  <h3 className="course__title">
                    <Link href="/course-details">
                      <a>Aprenda novas bases da teoria musical</a>
                    </Link>
                  </h3>
                  <div className="course__teacher d-flex align-items-center">
                    <div className="course__teacher-thumb mr-15">
                ...
                <div className="course__more d-flex justify-content-between align-items-center">
                  <div className="course__status d-flex align-items-center">
                    <span className="sky-blue">Grátis</span>
            ...
            <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
              <div className="course__item white-bg mb-30 fix">
                <div className="course__thumb w-img p-relative fix">
                  ...
                  <div className="course__tag">
                    <Link href="/course-details">
                      <a className="green">Desenvolvimento</a>
                    </Link>
                  </div>
                </div>
                <div className="course__content">
                  <div className="course__meta d-flex align-items-center justify-content-between">
                    <div className="course__lesson">
                      <span>
                        <i className="fas fa-book"></i>14 Lições
                      </span>
                    </div>
                    <div className="course__rating">
                      <span>
                  ...
                  <h3 className="course__title">
                    <Link href="/course-details">
                      <a>Lei da estratégia e fundação organizacional</a>
                    </Link>
                  </h3>
                  <div className="course__teacher d-flex align-items-center">
                    <div className="course__teacher-thumb mr-15">
              ...
              <div className="course__item white-bg mb-30 fix">
                ...
                <div className="course__content">
                  <div className="course__meta d-flex align-items-center justify-content-between">
                    <div className="course__lesson">
                      <span>
                        <i className="fas fa-book"></i>22 Lições
                      </span>
                    </div>
                    <div className="course__rating">
                      <span>
                  ...
                  <h3 className="course__title">
                    <Link href="/course-details">
                      <a>O curso de análise inteligente de negócios de 2022</a>
                    </Link>
                  </h3>
                  <div className="course__teacher d-flex align-items-center">
                    <div className="course__teacher-thumb mr-15">
                ...
                <div className="course__more d-flex justify-content-between align-items-center">
                  <div className="course__status d-flex align-items-center">
                    <span className="blue">Grátis</span>
            ...
            <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
              <div className="course__item white-bg mb-30 fix">
                <div className="course__thumb w-img p-relative fix">
                  ...
                  <div className="course__tag">
                    <Link href="/course-details">
                      <a className="orange">Áudio & Música</a>
                    </Link>
                  </div>
                </div>
                <div className="course__content">
                  <div className="course__meta d-flex align-items-center justify-content-between">
                    <div className="course__lesson">
                      <span>
                        <i className="fas fa-book"></i>18 Lições
                      </span>
                    </div>
                    <div className="course__rating">
                      <span>
                  ...
                  <h3 className="course__title">
                    <Link href="/course-details">
                      <a>Construa sua presença na media e no público</a>
                    </Link>
                  </h3>
                  <div className="course__teacher d-flex align-items-center">
                    <div className="course__teacher-thumb mr-15">
                ...
                <div className="course__more d-flex justify-content-between align-items-center">
                  <div className="course__status d-flex align-items-center">
                    <span className="orange">Grátis</span>
                    <span className="old-price">$97.00</span>
                  </div>
                  <div className="course__btn">
                    <Link href="/course-details">
              ...
              <div className="course__item white-bg mb-30 fix">
                ...
                <div className="course__content">
                  <div className="course__meta d-flex align-items-center justify-content-between">
                    <div className="course__lesson">
                      <span>
                        <i className="fas fa-book"></i>13 Lições
                      </span>
                    </div>
                    <div className="course__rating">
                      <span>
                  ...
                  <h3 className="course__title">
                    <Link href="/course-details">
                      <a>Escrita criativa através de narrativa</a>
                    </Link>
                  </h3>
                  <div className="course__teacher d-flex align-items-center">
                    <div className="course__teacher-thumb mr-15">
                ...
                <div className="course__more d-flex justify-content-between align-items-center">
                  <div className="course__status d-flex align-items-center">
                    <span className="pink">Grátis</span>
