              ...
              <div className="course__tab-wrapper d-flex align-items-center">
                <div className="course__tab-btn">
                  <TabList>
                    ...
                    <Tab>
                      <button className="nav-link" id="grid-tab" type="button">
                      ...
                      <div className="row gx-0">
                        <div className="col-xxl-4 col-xl-4 col-lg-4">
                          <div className="course__thumb course__thumb-list w-img p-relative fix">
                            ...
                            <div className="course__tag">
                              <Link href="/course-details">
                                <a className="blue-2">Art & Design</a>
                              </Link>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="course__right">
                            <div className="course__content course__content-3">
                              <div className="course__meta d-flex align-items-center">
                                ...
                                <div className="course__rating">
                                  <span>
                                    <i className="fas fa-star"></i>3.5 (32)
                                  </span>
                                </div>
                              </div>
                              <h3 className="course__title course__title-3">
                      ...
                      <div className="row gx-0">
                        <div className="col-xxl-4 col-xl-4 col-lg-4">
                          <div className="course__thumb course__thumb-list w-img p-relative fix">
                            ...
                            <div className="course__tag">
                              <Link href="/course-details">
                                <a className="green">Art & Design</a>
                              </Link>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="row gx-0">
                        <div className="col-xxl-4 col-xl-4 col-lg-4">
                          <div className="course__thumb course__thumb-list w-img p-relative fix">
                            ...
                            <div className="course__tag">
                              <Link href="/course-details">
                                <a className="yellow">Art & Design</a>
                              </Link>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="course__right">
                            <div className="course__content course__content-3">
                              <div className="course__meta d-flex align-items-center">
                                <div className="course__lesson mr-20">
                                  <span>
                                    <i className="fas fa-book"></i>33 Lesson
                                  </span>
                                </div>
                                <div className="course__rating">
                                  <span>
                                    <i className="fas fa-star"></i>3.5 (72)
                                  </span>
                                </div>
                              </div>
                              <h3 className="course__title course__title-3">
                  ...
                  <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div className="course__item white-bg mb-30 fix">
                      <div className="course__thumb w-img p-relative fix">
                        ...
                        <div className="course__tag">
                          <Link href="/course-details">
                            <a className="sky-blue">Mechanical</a>
                          </Link>
                        </div>
                      </div>
                      <div className="course__content">
                  ...
                  <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div className="course__item white-bg mb-30 fix">
                      <div className="course__thumb w-img p-relative fix">
                        ...
                        <div className="course__tag">
                          <Link href="/course-details">
                            <a className="blue-2">Development</a>
                          </Link>
                        </div>
                      </div>
                      <div className="course__content">
                        <div className="course__meta d-flex align-items-center justify-content-between">
                          ...
                          <div className="course__rating">
                            <span>
                              <i className="fas fa-star"></i>4.4 (40)
                            </span>
                          </div>
                        </div>
                        <h3 className="course__title">
                          <Link href="/course-details">
                            <a>Bases Matemáticas dios Álgebra Ecuacion</a>
                          </Link>
                        </h3>
                        <div className="course__teacher d-flex align-items-center">
                          <div className="course__teacher-thumb mr-15">
                  ...
                  <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div className="course__item white-bg mb-30 fix">
                      <div className="course__thumb w-img p-relative fix">
                        ...
                        <div className="course__tag">
                          <Link href="/course-details">
                            <a className="blue-2">UX Design</a>
                          </Link>
                        </div>
                      </div>
                      <div className="course__content">
                        <div className="course__meta d-flex align-items-center justify-content-between">
                          ...
                          <div className="course__rating">
                            <span>
                              <i className="fas fa-star"></i>4.5 (35)
                            </span>
                          </div>
                        </div>
                        <h3 className="course__title">
